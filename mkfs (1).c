...
int main(int argc, char *argv[]) {
	...
	bgds.bg_block_bitmap = block_groups + 1;
	bgds.bg_inode_bitmap = bgds.bg_block_bitmap + 1;
	bgds.bg_inode_table = bgds.bg_inode_bitmap + 1;
	bgds.bg_free_blocks_count;
	bgds.bg_free_inodes_count;
	...
	in.i_dtime = 0;
	in.i_gid;		/* Low 16 bits of Group Id */
	in.i_links_count = 1;
	in.i_blocks = 8;
	in.i_flags = 0;
	in.osd1.linux1.l_i_version = 0;
	in.osd1.hurd1.h_i_translator = 0;
	in.i_block[EXT2_N_BLOCKS];/* Pointers to blocks */
	in.i_generation = 0;
	in.i_file_acl = 0;
	in.i_size_high = 0;
	in.i_faddr = 0;
